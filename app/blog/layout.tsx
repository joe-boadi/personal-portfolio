import { CopyButton } from "./blog-post"
...
export default function LayoutBlogPost({
  ...
  return (
    <>
      <div aria-description="Blog-Post" className="pointer-events-none fixed left-0 top-0 z-10 h-12 w-full bg-gray-100 to-transparent backdrop-blur-xl [-webkit-mask-image:linear-gradient(to_bottom,black,transparent)] dark:bg-zinc-950" />
      <ScrollProgress
      ...
      />
      <div title="Copy" className="absolute right-4 top-24">
        <CopyButton />
      </div>
